...
nodeTemplate.jvminfotable = [
    ...
    '<% if(versionUtil.isNewer("0.99.0", cluster.versionNumber.concat)) { %>',
    '<tr><td>GC (Young) Count:</td><td><%- jvmStats.gc.collectors.young.collection_count %></td></tr>',
    '<tr><td>GC (Young)Time:</td><td><%- timeUtil.convertMS(jvmStats.gc.collectors.young.collection_time_in_millis) %></td></tr>',
    '<tr><td>GC (Old) Count:</td><td><%- jvmStats.gc.collectors.old.collection_count %></td></tr>',
    '<tr><td>GC (Old)Time:</td><td><%- timeUtil.convertMS(jvmStats.gc.collectors.old.collection_time_in_millis) %></td></tr>',
    '<% } else { %>',
